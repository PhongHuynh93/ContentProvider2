 ...
 */
// TODO: 5/13/16 bước 6 tạo content provider class, khai báo uri cho 1 hàng và 1 giá trị trong hàng  
public class MovieProvider extends ContentProvider {
    ...
    // TODO: 5/13/16 bước 7: gọi khởi tạo database từ content provider
    ...
    // TODO: 5/13/16 bước 8: method sẽ match số int ở trên vào uri của content provider
    ...
    public static UriMatcher buildUriMatcher() {
        ...
        matcher.addURI(content, MovieContract.PATH_GENRE, GENRE); // tìm table tên này
        matcher.addURI(content, MovieContract.PATH_GENRE + "/#", GENRE_ID); // tìm row với di này
    ...
    // TODO: 5/13/16 bước 10: hiện thực hàm query
    @Nullable
    @Override
    ...
    // TODO: 5/13/16 bước 9: hiện thực hàm này để find the MIME type of the results, either a directory of multiple results, or an individual item:
    @Nullable
    @Override
